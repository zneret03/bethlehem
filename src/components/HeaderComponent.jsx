            ...
            <div className="absolute top-0 left-0 z-20 p-5" key="logo">
                <a className="flex" href="https://bcif.netlify.com">
                    ...
                    <div className="border-l-2 mx-3"/>
                        <span className="font-bold text-3xl uppercase font-sans">{name}</span>
                    </a>
            </div>
            <Sidebar open={show} close={(e) => sideBarClose(e)} key="sidebar">
            <div className="float-right p-5">
                {hamburger ? (
                    <button className="border py-2 px-3 rounded font-bold bg-white z-50" onClick={(e) => sideBarOpen(e)}><Menu size="20" color="#000"/></button>
                ) : (
